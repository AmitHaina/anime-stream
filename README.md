...
A Netflix-style demo player built on top of a public anime streaming API. It exists to
...
live from the upstream site's own public API/CDN, this project stores nothing and hosts no content
itself.
